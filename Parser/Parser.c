 ...
 ***********************************************************
 */
 /* This is the function to start the parser - adjusted program definition */
void startParser() {
	lookahead = tokenizer();
 ...
 ***********************************************************
 */
 /* This is the main code for match - adjusted definition */
 ...
 ***********************************************************
 */
 /* This is the function to handle error - adjusted data types */
 ...
 ***********************************************************
 */
 /* This is the function for error printing - adjusted data types */
void printError() {
	Token t = lookahead;
 ...
 ***********************************************************
 */
Learn_void optVarListDeclarations() {
	switch (lookahead.code) {
	default:
		; // Empty
	}
